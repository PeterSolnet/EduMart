    ...
    <div id="login-box" class="login-box visible widget-box no-border">
        <div class="widget-body">
            ...
            <div class="widget-main">
                ...
                <form autocomplete="off" class="form-horizontal" role="form" method="POST" action="{{ url('/admin_login') }}">
                    {{ csrf_field() }}
                    <fieldset>
            ...
            <div class="toolbar clearfix">
                <div>
                    <a href="{{ url('/admin_password/reset') }}" data-target="#forgot-box" class="forgot-password-link">
                ...
                <div>
                    <a href="{{ url('/admin_register') }}" data-target="#signup-box" class="user-signup-link">
                        I want to register
